...
func (c *Client) login(m map[string]string) (*Result, *AppError) {
	if r, err := c.DoApiPost("/users/login", MapToJson(m)); err != nil {
		...
		if c.AuthToken != sessionToken.Value {
			NewLocAppError("/users/login", "i18n.server.model.client.login.app_error", nil, "")
		}
...
func (c *Client) DownloadComplianceReport(id string) (*Result, *AppError) {
	...
	if rp, err := c.HttpClient.Do(rq); err != nil {
		return nil, NewLocAppError("/admin/download_compliance_report", "i18n.server.model.client.connecting.app_error", nil, err.Error())
	} else if rp.StatusCode >= 300 {
		defer rp.Body.Close()
		return nil, AppErrorFromJson(rp.Body)
	} else {
...
func (c *Client) UploadPostAttachment(data []byte, channelId string, filename string) (*FileUploadResponse, *AppError) {
	...
	if part, err := writer.CreateFormFile("files", filename); err != nil {
		return nil, NewLocAppError("UploadPostAttachment", "i18n.server.model.client.upload_post_attachment.file.app_error", nil, err.Error())
	} else if _, err = io.Copy(part, bytes.NewBuffer(data)); err != nil {
		return nil, NewLocAppError("UploadPostAttachment", "i18n.server.model.client.upload_post_attachment.file.app_error", nil, err.Error())
	}

	if part, err := writer.CreateFormField("channel_id"); err != nil {
		return nil, NewLocAppError("UploadPostAttachment", "i18n.server.model.client.upload_post_attachment.channel_id.app_error", nil, err.Error())
	} else if _, err = io.Copy(part, strings.NewReader(channelId)); err != nil {
		return nil, NewLocAppError("UploadPostAttachment", "i18n.server.model.client.upload_post_attachment.channel_id.app_error", nil, err.Error())
	}

	if err := writer.Close(); err != nil {
		return nil, NewLocAppError("UploadPostAttachment", "i18n.server.model.client.upload_post_attachment.writer.app_error", nil, err.Error())
	}
...
func (c *Client) CreateEmoji(emoji *Emoji, image []byte, filename string) (*Emoji, *AppError) {
	...
	if part, err := writer.CreateFormFile("image", filename); err != nil {
		return nil, NewLocAppError("CreateEmoji", "i18n.server.model.client.create_emoji.image.app_error", nil, err.Error())
	} else if _, err = io.Copy(part, bytes.NewBuffer(image)); err != nil {
		return nil, NewLocAppError("CreateEmoji", "i18n.server.model.client.create_emoji.image.app_error", nil, err.Error())
	}

	if err := writer.WriteField("emoji", emoji.ToJson()); err != nil {
		return nil, NewLocAppError("CreateEmoji", "i18n.server.model.client.create_emoji.emoji.app_error", nil, err.Error())
	}

	if err := writer.Close(); err != nil {
		return nil, NewLocAppError("CreateEmoji", "i18n.server.model.client.create_emoji.writer.app_error", nil, err.Error())
	}
	...
	if r, err := c.HttpClient.Do(rq); err != nil {
		return nil, NewLocAppError("CreateEmoji", "i18n.server.model.client.connecting.app_error", nil, err.Error())
...
func (c *Client) UploadCertificateFile(data []byte, contentType string) *AppError {
	...
	if rp, err := c.HttpClient.Do(rq); err != nil {
		return NewLocAppError(url, "i18n.server.model.client.connecting.app_error", nil, err.Error())
	} else if rp.StatusCode >= 300 {
